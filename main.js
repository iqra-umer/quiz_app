...
if (answer.quiz === 'b. Numbers, strings, booleans') {
    ...
    console.log(chalk.red('YOUR ANSWER IS INCORRECT!!! THE RIGHT ANSWER IS b'));
}
;
console.log('-----------------------------------------------------------');
...
if (answer2.quiz2 === 'c. It allows for flexibility but compromises safety') {
    ...
    console.log(chalk.red(`YOUR ANSWER IS INCORRECT!!! THE CORRECT ANSWER IS c`));
    incorrectCount++;
}
;
console.log('-------------------------------------------------');
...
if (answer3.quiz3 === 'a. For handling large numerical values') {
    ...
    console.log(chalk.red(`YOUR ANSWER IS INCORRECT!!! THE CORRECT ANSWER IS a`));
    incorrectCount++;
}
;
console.log('-------------------------------------------------');
...
if (answer4.quiz4 === 'b. array') {
    ...
    console.log(chalk.red(`YOUR ANSWER IS INCORRECT!!! THE CORRECT ANSWER IS b`));
    incorrectCount++;
}
;
console.log('-------------------------------------------------');
